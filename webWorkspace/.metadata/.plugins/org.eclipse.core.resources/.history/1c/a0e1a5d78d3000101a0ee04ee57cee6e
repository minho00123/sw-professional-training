...
<body>
	...
	<form action="edit.do" method="post">
		...
		<div class="form-group">
			<label>dname</label><input class="form-control" name="dname" value="${bean.dname }" readonly />
		</div>
		<div class="form-group">
			<label>location</label>
			<select name="loc" class="form-control" disabled>
		...
		<div class="text-center">
			<a class="btn btn-default" href="edit.do?deptno=${bean.deptno }" role="button">수정</a>
			<a class="btn btn-danger" href="delete.do?deptno=${bean.deptno }" role="button">삭제</a>
