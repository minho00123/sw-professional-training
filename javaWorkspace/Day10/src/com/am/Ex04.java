...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		System.out.println(target.byteValue()); // 1 byte = 0~255 -> -128~127
		...
		System.out.println(Integer.valueOf(target.toString())+1); // return Ingeter
		...
		System.out.println(Integer.reverse(1)+1); // 비트 단위로 리버스
