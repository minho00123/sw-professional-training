...
//		}
		...
		System.out.println(cal.get(Calendar.DAY_OF_MONTH) + "일"); // 5
		System.out.println(cal.get(Calendar.DATE) + "일"); // 5
//		System.out.println(cal.get(Calendar.AM_PM));
//		System.out.println(cal.get(Calendar.AM_PM) == Calendar.AM);
//		System.out.println(cal.get(Calendar.AM_PM) == Calendar.PM);
//		System.out.println(cal.get(Calendar.HOUR) + "시"); // 10
		...
		System.out.println("----------------------------------------------------------------------");
		System.out.println("365일 중 " + cal.get(Calendar.DAY_OF_YEAR) + "일");
		System.out.println("일년중" + cal.get(Calendar.WEEK_OF_YEAR) + "주차");
